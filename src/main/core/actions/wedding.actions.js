...
export const WEDDING_EDIT_SUCCESSFUL = 'WEDDING_EDIT_SUCCESSFUL';
export const WEDDING_EDIT_VALIDATE = 'WEDDING_EDIT_VALIDATE';
export const WEDDING_EDIT_FAILED = 'WEDDING_EDIT_FAILED';
